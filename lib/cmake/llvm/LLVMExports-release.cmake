...
# Import target "OpenMPVerify" for configuration "Release"
set_property(TARGET OpenMPVerify APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(OpenMPVerify PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/OpenMPVerify.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )

list(APPEND _IMPORT_CHECK_TARGETS OpenMPVerify )
list(APPEND _IMPORT_CHECK_FILES_FOR_OpenMPVerify "${_IMPORT_PREFIX}/lib/OpenMPVerify.so" )
...
set_target_properties(LTO PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libLTO.so.7.1.0"
  IMPORTED_SONAME_RELEASE "libLTO.so.7.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS LTO )
list(APPEND _IMPORT_CHECK_FILES_FOR_LTO "${_IMPORT_PREFIX}/lib/libLTO.so.7.1.0" )
